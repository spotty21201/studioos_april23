...
- design-related thinking and concept development
- communication materials and narrative development
- research support and structured analysis
- documentation, presentation, and proposal support
...
## Primary Use of This Repository
...
- document and note structure
- calm operational oversight
- Principal-first experience in V1
...
- use terms like rb, jt, M, T for practical uses of units

Unless explicitly stated otherwise:

- financial values should default to **IDR**
- monetary formatting should assume Indonesian context
- if multi-currency support is introduced later, IDR should remain the default base currency

---

## Language and Communication Preferences

Default communication preferences for this project:

- **Primary working language:** Bahasa Indonesia and English. But for application and SaaS, English is the main language
- internal strategic and product documentation should remain in **English**
- do not translate content into Bahasa Indonesia unless explicitly requested
- preserve original English wording where possible in product and repo documentation
...
- UX writing drafts
- system labels and product thinking
...
- modern, light UI rather than dark, noisy dashboard styles
- dashboard-first where leadership visibility matters
- table-first where clarity matters
- modular architecture with room for growth
- simplicity in V1, depth later

The product should avoid:

- ERP-like clutter
- decorative dashboard theater
- unnecessary complexity
- overbuilt finance logic in early versions
- playful consumer-app behavior when building internal studio tools

---

## Operational Preferences

For this repository and product context, assume the following unless overridden:

- single-studio mode for V1
- Principal-first user experience in V1
- modern web stack orientation
- frontend clarity is a major priority
- backend should remain structured and extensible
- documentation should be treated as part of the product foundation, not an afterthought

---

## Role of Documentation

Documentation in this project is operationally important.
...
should function as part of the project’s working memory and alignment layer for both humans and coding agents.
